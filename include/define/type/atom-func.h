...
#  define __atom_store(ptr, val, mo) __c11_atomic_store(ptr, val, mo)
#  define __atom_load(ptr, mo)       __c11_atomic_load(ptr, mo)

#  define __atom_add(ptr, val, mo) __c11_atomic_fetch_add(ptr, val, mo)
#  define __atom_sub(ptr, val, mo) __c11_atomic_fetch_sub(ptr, val, mo)
#  define __atom_or(ptr, val, mo)  __c11_atomic_fetch_or(ptr, val, mo)
#  define __atom_and(ptr, val, mo) __c11_atomic_fetch_and(ptr, val, mo)
#  define __atom_xor(ptr, val, mo) __c11_atomic_fetch_xor(ptr, val, mo)

#  define __atom_tas(ptr, mo) __c11_atomic_exchange(ptr, true, mo)
#  define __atom_clr(ptr, mo) __c11_atomic_store(ptr, false, mo)

#  define __atom_exch(ptr, val, mo) __c11_atomic_exchange(ptr, val, mo)

#  define __atom_cexch(ptr, expected, val, smo, fmo)                                               \
    __c11_atomic_compare_exchange_strong(ptr, expected, val, smo, fmo)
#  define __atom_cexch_weak(ptr, expected, val, smo, fmo)                                          \
    __c11_atomic_compare_exchange_weak(ptr, expected, val, smo, fmo)
