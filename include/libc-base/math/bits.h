...
finline __attr(const) u8 bit_reverse_8(u8 x) {
  x = ((x & 0x55) << 1) | ((x >> 1) & 0x55);
  x = ((x & 0x33) << 2) | ((x >> 2) & 0x33);
  x = ((x & 0x0f) << 4) | ((x >> 4) & 0x0f);
  return x;
}
finline __attr(const) u16 bit_reverse_16(u16 x) {
...
finline __attr(const) u32 bit_reverse_32(u32 x) {
...
finline __attr(const) u64 bit_reverse_64(u64 x) {
...
finline __attr(const) u8 byteswap8(u8 x) {
  return x;
}
finline __attr(const) u16 byteswap16(u16 x) {
  x = ((x & 0x00ff) << 8) | ((x >> 8) & 0x00ff);
  return x;
}
finline __attr(const) u32 byteswap32(u32 x) {
  x = ((x & 0x00ff00ff) << 8) | ((x >> 8) & 0x00ff00ff);
  x = (x << 16) | (x >> 16);
  return x;
}
finline __attr(const) u64 byteswap64(u64 x) {
  x = ((x & 0x00ff00ff00ff00ff) << 8) | ((x >> 8) & 0x00ff00ff00ff00ff);
  x = ((x & 0x0000ffff0000ffff) << 16) | ((x >> 16) & 0x0000ffff0000ffff);
  x = (x << 32) | (x >> 32);
  return x;
